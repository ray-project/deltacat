...
from deltacat.dev.daft_integration.io._deltacat import DeltaCATCatalog as DaftDeltaCATCatalog
...
class TestDaftCatalogIntegration:
    ...
    def setup_method(self):
        ...
        import deltacat.dev.daft_integration.io._deltacat
    ...
    def test_from_deltacat_catalog_conversion(self, mock_default):
        ...
        catalog_props = CatalogProperties(metastore_uri="s3://test-bucket/test-metastore")
