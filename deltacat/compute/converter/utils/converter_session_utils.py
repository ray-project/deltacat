def check_data_files_sequence_number(data_files_list, equality_delete_files_list):
    ...
    for equality_file_tuple in equality_delete_files_list:
        ...
        while data_file_pointer < len(data_files_list) and data_files_list[data_file_pointer][0] < equality_file_tuple[0]:
    ...
    result_equality_delete_file = append_larger_sequence_number_data_files(equality_delete_files)
