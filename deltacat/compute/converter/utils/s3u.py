...
from deltacat.types.tables import get_table_writer, get_table_length, TABLE_CLASS_TO_SLICER_FUNC
...
def get_s3_file_system(content_type):
    ...
    s3_file_system = s3fs.S3FileSystem(
        ...
        s3_additional_kwargs={
            ...
            # "Tagging": f"stream_uuid={stream_uuid}&"
            #            f"manifest_uuid={manifest_uuid}&"
            #            f"shard_uuid={shard_uuid}",
...
def upload_table(table_slices, s3_base_url, s3_file_system, s3_table_writer_func, block_write_path_provider, content_type, s3_table_writer_kwargs):
