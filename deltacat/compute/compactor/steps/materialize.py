...
def materialize(
    ...
    with memray.Tracker(
        ...
        for src_dfl in sorted(all_src_file_records.keys()):
            ...
            print(f"DEBUG:_materialize {round_completion_info=} {is_src_partition_file_np=}")
            ...
            if (
                ...
                # print(f"DEBUG:materialize {src_file_idx_np=}, {read_kwargs_provider=}, {kwargs=}, {record_number=}, {manifest=}, {delta_locator=}")
