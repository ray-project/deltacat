...
class Dataset:
    ...
    def from_parquet(
        ...
        file_uri, filesystem = FileStore.filesystem(file_uri, filesystem=filesystem)
        metadata_uri = filesystem.normalize_path(
        ...
        if schema_mode == "intersect":
            ...
            for file in pyarrow_dataset.files:
                with filesystem.open_input_file(file) as f:
    ...
    def from_json(
        ...
        pyarrow_table = pyarrow.json.read_json(file_uri, filesystem=filesystem)
