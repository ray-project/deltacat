...
class IcebergScanPlanner(ScanPlanner):
    ...
    def create_scan_plan(self, table_name: str, namespace: Optional[str] = None, pushdown: Optional[Pushdown] = None) -> ScanPlan:
        iceberg_table = _try_load_iceberg_table(self.catalog, namespace=namespace, table_name=table_name)
        file_scan_tasks = []
