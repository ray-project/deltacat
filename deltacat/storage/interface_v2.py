"""
This V2 interface is a work in progress

While we are developing it, we will keep the V1 interface for compatibility with existing iceberg impl

After development, we will build parity with V1 interface, update iceberg impl, and update users of iceberg impl
"""
...
from deltacat.storage import (
    ...
    TableProperties,
    TableVersion,
    TableVersionProperties, StreamFormat,
)
...
def get_stream(
    ...
    table version is given.

    Returns None if the table version does not exist.
    """
