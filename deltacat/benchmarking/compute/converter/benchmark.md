# Initial Benchmark Results - Largest Sustainable Table
...
- **Resource Allocation**:
  ...
  - **Note**: All compute jobs run exhausting Python heap memory during execution
...
| Bytes per record per PK column | 20 bytes |
| Total records | 167.16 billion |
| PK data in memory | 10.02 TB |
| Total in-memory usage | ~48.76 TB |
| **Infrastructure** | |
| EC2 nodes | 114 |
...
**Testing Environment**: Most heavily tested with Ray version 2.30 and AWS R8g.large instances.
