...
class TestMergeIntervals(unittest.TestCase):
    def test_unbounded_start_range(self):
        ...
        interval: Tuple[UnboundedRange, UnboundedRange] = intervals[0]
    ...
    def test_no_overlap_range(self):
        ...
        interval1: Tuple[UnboundedRange, UnboundedRange] = intervals[0]
        interval2: Tuple[UnboundedRange, UnboundedRange] = intervals[1]
        interval3: Tuple[UnboundedRange, UnboundedRange] = intervals[2]
