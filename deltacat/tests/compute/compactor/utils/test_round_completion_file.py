...
class TestReadWriteRoundCompletionFile:
    ...
    def test_read_when_rcf_written_with_destination(self, temp_catalog):
        ...
        assert rcf_url.endswith("f9829af39770d904dbb811bd8f4e886dd307f507/e9939deadc091b3289a2eb0ca56b1ba86b9892f4.json")
        assert rcf == expected_rcf

    def test_read_without_destination_when_rcf_written_with_destination(self, temp_catalog):
        """
        This test case tests the backward compatibility by successfully
        reading the previously written rcf.
        """
    ...
    def test_read_without_destination_when_rcf_written_without_destination(self, temp_catalog):
        """
        This test case tests the backward compatibility by successfully
        reading the previously written rcf.
        """
        ...
        write_round_completion_file(compaction_artifact_path, source_locator, None, expected_rcf)

        rcf = read_round_completion_file(compaction_artifact_path, source_locator, None)

        assert rcf == expected_rcf

    def test_read_when_rcf_written_both_with_and_without_destination(self, temp_catalog):
        """
        This test case tests the backward compatibility by successfully
        reading the previously written rcf.
        """
        ...
        write_round_completion_file(
            compaction_artifact_path, source_locator, destination_locator, expected_rcf_2
        )
