...
@pytest.mark.parametrize(
    ...
    [
        ...
        for test_name, (
            ...
            skip_enabled_compact_partition_drivers,
            compact_partition_func,
        ) in NO_RCF_OUTPUT_TEST_CASES.items()
    ],
    ids=[test_name for test_name in NO_RCF_OUTPUT_TEST_CASES],
    indirect=[],
)
def test_compact_partition_no_rcf_output(
    ...
    # validate
    assert rcf_file_s3_uri is None
