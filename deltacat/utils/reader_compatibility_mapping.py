...
READER_COMPATIBILITY_MAPPING = {
    ...
    ("date64[ms]", "pyarrow", "application/avro"): [DatasetType.RAY_DATASET],
    ("date64[ms]", "pyarrow", "application/feather"): [
        DatasetType.PANDAS,
        DatasetType.PYARROW,
        DatasetType.RAY_DATASET,
    ],
    ("date64[ms]", "pyarrow", "application/orc"): [DatasetType.RAY_DATASET],
    ...
    ("map", "pyarrow", "application/avro"): [DatasetType.RAY_DATASET],
    ...
    ("struct", "polars", "application/feather"): [DatasetType.POLARS],
