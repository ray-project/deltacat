...
def s3_file_to_table(
    ...
    **s3_client_kwargs,
    ...
    if (
        ...
        # TODO(sammy): pass row groups to daft reader as well.
        # We currently take in the row offset and len rather than the indices of the requested row groups.
        # Should be a simple change to have the option for both
